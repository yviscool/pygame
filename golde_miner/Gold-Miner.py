...
# 0-preparation
# general
# camera=gamebox.Camera(1000, 700, True)
...
text_list = [
    "Gold sands:Small gold worths more in the next level",
    "Diamond polisher:Diamond worths 50% more in the next level",
    "Lamp:More diamond would appear in the next level",
    "The Gem of Time:You have 20 more seconds in the next level",
    "The Gem of Luck:You have higher chance of getting good stuff from the random bags.",
    "The Gem of Strength:Pulling minerals back takes less time in the next level",
    "The lucky Rock:Rock worths 300% more in the next level",
    "SOLD OUT!"]
...
def tick(keys):
    ...
    if scene == 2:
        ...
        if chain_thrown_out == False:
            ...
            # chain head displays
            pos = (
                500 + math.sin(radins / 57.29) * 75,
                75  + math.cos(radins / 57.29) * 75,
            )
            ...
            for i in range(0, 25):
                item = gamebox.from_color(
                    500 + math.sin(radins/57.29) * 2.5 * i,
                    75  + math.cos(radins/57.29) * 2.5 * i,
                    "black",
                    5,
                    5
                )
